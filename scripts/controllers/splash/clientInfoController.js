(function () {
    'use strict';
    angular.module('GMA').controller('ClientInfoController', function ($scope, $state, $timeout, splashSettings, api, storage, serverUrlHandler, pushNotificationHandler, $q) {
        ...
        api.client.details().then(function (data) {
            ...
            if (data != null) {
                ...
                storage.data.IsRightToLeft = false;// data.IsRightToLeft;
